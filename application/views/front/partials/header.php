...
<body>
    ...
    <!-- Navigation -->
    <nav class="navbar navbar-expand-md navbar-light bg-indigo-800 sticky-top">
        <div class="container-fluid">
            <a class="navbar-brand" href="<?php echo base_url().'home/index';?>"><i class="fas fa-utensil-spoon"></i> InstaServe</a>
            ...
            <div class="collapse navbar-collapse" id="navbarRes">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item active">
                        <a class="nav-link" href="<?php echo base_url().'singup/index'?>">Sign Up</a>
                    </li>
                    <?php } else {?>
